...
## Project Structure
    ...
    ├── templatetesting_dev_37839  # Django project configurations
...
1. Clone this repo and `cd templatetesting_dev_37839`
...
2. Clone this repo and `cd templatetesting_dev_37839`
